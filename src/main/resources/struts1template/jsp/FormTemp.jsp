...
<html>
<head>
<title><bean:message bundle="&{appname}Res" key="&{entityname}.edit.title" /></title>
...
<body>
<p class="ctitle"><bean:message bundle="&{appname}Res" key="&{entityname}.edit.title" /></p>
...
<table width="200" border="0" cellpadding="1" cellspacing="1">		
 &{for-each:keyproperty}
				<tr>
					<td class="TDTITLE">
						<bean:message bundle="&{appname}Res" key="&{entityname}.&{keyproperty}" />
					</td>
					<td align="left">
...
&{for-each:property}
				<tr>
					<td class="TDTITLE">
						<bean:message bundle="&{appname}Res" key="&{entityname}.&{property}" />
					</td>
					<td align="left">
...
&{for-each:subkeyproperty}&{if:!keypropertyisref}  
				<td class="tableHeader">
					<bean:message bundle="&{appname}Res" key="&{subentityname}.&{subkeyproperty}" />
				</td>&{end-if}	
&{end-for-each}
&{for-each:subproperty}&{if:!propertyisref}
				<td class="tableHeader">
					<bean:message bundle="&{appname}Res" key="&{subentityname}.&{subproperty}" />
				</td>&{end-if}	
&{end-for-each}		
				<td class="tableHeader">
